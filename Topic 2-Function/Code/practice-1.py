...
(1) create a function named `square`, which returns the square if inputting a value. 
(2) create a function named `area`, which returns the circle area if inputting radius. In this function, you call `square` function.
